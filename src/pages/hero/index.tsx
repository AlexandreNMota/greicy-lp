      ...
      <Grid sx={{ padding: "20px" }} container className="containerHome">
        {isMobile && (
          ...
          >
            ...
            <img
              src="images/greicy_home.png"
              className="greicyHome-mobile"
            ></img>
          </Grid>
        )}
        <Grid
          ...
          sm={5}
          md={5}
          sx={{ marginLeft: !isMobile ? "70px" : "0" }}
        >
          <Typography
            className="poppins titleHome"
            sx={{ color: "#00296D" }}
            variant="h3"
          >
            Procurando uma <span style={{ color: "#89BBE0" }}>Psicóloga</span>{" "}
            de confiança?
          </Typography>
          <Grid item xs={12} sm={8} md={8}>
            {!isMobile && (
              <Typography
                className="source-sans-3 subtitleHome"
                variant="subtitle1"
                sx={{ m: 1 }}
              >
                Psicóloga, Professora, Palestrante e Autora. Especialista em
                Terapias Cognitivas, Neuropsicologica, Gestão de Pessoas e
                Coach, e Educação a Distância.
              </Typography>
            )}
            ...
            >
              Atendimentos{" "}
              <span className="source-sans-3-400" style={{ color: "#44C6E9" }}>
                on-line
              </span>{" "}
              e presencial dentro da abordagem Terapia Cognitiva Comportamental
              a Adolescentes, Adultos, Idosos e Casais.
            </Typography>
            <Box
              display="flex"
              alignItems={"center"}
            ...
            >
              ...
              <Typography
                sx={{ color: "#44C6E9" }}
                className="source-sans-3-400 subtitleHome"
                variant="subtitle1"
              >
                Dra.Greicy Pais
              </Typography>
